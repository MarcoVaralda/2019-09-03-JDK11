...
public class FoodDao {
	...
	public List<Adiacenza> getArchi(int calorie){
		String sql = "SELECT p1.portion_display_name AS p1, p2.portion_display_name AS p2, COUNT(*) AS peso "
	...
	public List<String> tipiDiPorzione(int calorie) {
